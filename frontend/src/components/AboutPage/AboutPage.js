...
const CONTENT = [
  ...
  { key: 'h4', type: 'heading', tag: 'h2', sec: 4, text: 'How I work' },
  {
    ...
    text:
      "I'm happiest where research curiosity meets shipping discipline: prototyping a bold idea, then doing the unglamorous work to make it correct, fast, and maintainable. Browse the projects and publications above, and feel free to ask LedbetterLM, my AI librarian in the corner, anything about my work.",
  },
];
